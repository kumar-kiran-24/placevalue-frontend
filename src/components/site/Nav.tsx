...
export function Nav() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 flex justify-center px-4 py-3">
      <nav className="glass-strong w-full max-w-6xl rounded-full px-6 py-2 flex items-center justify-between backdrop-blur-md">
        <Link to="/" className="flex items-center gap-2 shrink-0">
          <img src={logoAsset} alt="PlaceValue" className="h-8 w-auto" />
        </Link>

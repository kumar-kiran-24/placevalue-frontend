    ...
    <SiteShell>
      <div className="relative overflow-hidden w-full">
        ...
        <section className="relative pt-24 md:pt-36 pb-20 px-6 md:px-12">
          <div className="relative max-w-7xl mx-auto text-center">
            <Reveal delay={100}>
            <h1 className="mt-6 text-[clamp(2.6rem,7vw,6rem)] font-extrabold leading-[0.96] tracking-[-0.045em] max-w-5xl mx-auto" style={{ fontFamily: 'var(--font-hero)' }}>
              We're closing the last mile<br/>
              between <span className="text-gradient">education and employment.</span>
            </h1>
          </Reveal>
        </div>
      </section>
      ...
      <section className="relative px-6 md:px-12 py-24">
        <div className="relative max-w-7xl mx-auto">
          <Reveal>
            <h2 className="text-[clamp(2rem,4.2vw,3.6rem)] font-extrabold leading-[1.02] tracking-[-0.035em] max-w-3xl" style={{ fontFamily: 'var(--font-hero)' }}>
              What we <span className="text-gradient">operate by.</span>
            </h2>
          </Reveal>

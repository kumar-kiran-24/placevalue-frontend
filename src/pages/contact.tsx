  ...
  return (
    <SiteShell>
      <div className="relative overflow-hidden w-full">
        ...
        <section className="relative pt-24 md:pt-36 pb-16 px-6 md:px-12">
          <div className="relative max-w-7xl mx-auto text-center">
            <Reveal delay={100}>
              <h1 className="mt-6 text-[clamp(2.4rem,6vw,5.4rem)] font-extrabold leading-[0.96] tracking-[-0.045em] max-w-4xl mx-auto" style={{ fontFamily: 'var(--font-hero)' }}>
                Let's bring TASKVERSE<br/>
                to your <span className="text-gradient">organisation.</span>
              </h1>
            </Reveal>
          </div>
        </section>
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left rounded-xl border px-5 py-4 flex items-start gap-3 transition-all ${
                      active ? "border-brand-blue/40 bg-brand-blue/[0.06]" : "border-border bg-surface/40 hover:border-mid"
                    }`}
                  >
